		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 footer-contacts">
			    ...
			    <div><i class="fa fa-envelope footer-contacts-icon"></i>
			        <p> <a href="${pageContext.request.contextPath}/contactus" target="_blank">support@shoppingcart.in</a></p>
			    </div>
			</div>
